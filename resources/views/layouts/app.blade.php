...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100">
            ...
            <div class="container mx-auto flex justify-between items-center">
                ...
                @auth
                    <nav class="flex gap-2 items-center">
                        <a class="flex items-center gap-2 bg-white border p-2 text-gray-600 text-sm uppercase font-bold cursor-pointer"
        ...
        <footer class="mt-10 uppercase text-center p-5 text-gray-500 font-bold">
            Devstagram - Todos los derechos son reservados 
            {{ now() -> year }}
        </footer>        
    </body>
</html>